...
\begin{document}
	...
	\cite{olfati2007}. Existing studies have extended consensus control
	to second-order systems with velocity and input constraints, as well
	as finite-time protocols with actuator saturation
	\cite{fu2019constraints,zhao2015finite}. Distributed average tracking
	of nonlinear dynamical systems has also been investigated
	\cite{zhao2019tracking}. Moreover, resilient consensus under malicious
	attacks has received increasing attention, including attack-isolation-
	and appointed-time-observer-based approaches
	\cite{zhao2022isolation,zhou2022appointed}.
	...
	information exchange. Although a single candidate topology may be
	disconnected and fail to guarantee global consensus independently,
	the union of several candidate topologies may be strongly connected
	and provide sufficient information paths. Existing studies have shown
	that consensus can still be achieved under jointly connected
	switching topologies even when each individual topology is
	insufficient \cite{cheng2019,li2023}.
	...
	\begin{thebibliography}{00}
		...
		Y.~Zhao, Y.~Liu, G.~Wen, X.~Yu, and G.~Chen,
		``Distributed average tracking for Lipschitz-type of nonlinear
		dynamical systems,''
		\emph{IEEE Transactions on Cybernetics},
		vol.~49, no.~12, pp.~4140--4152, 2019.
		
		\bibitem{zhao2022isolation}
		D.~Zhao, Y.~Lv, X.~Yu, G.~Wen, and G.~Chen,
		``Resilient consensus of higher order multiagent networks:
		An attack isolation-based approach,''
		\emph{IEEE Transactions on Automatic Control},
		vol.~67, no.~2, pp.~1001--1007, 2022.
		
		\bibitem{zhou2022appointed}
		J.~Zhou, Y.~Lv, G.~Wen, and X.~Yu,
		``Resilient consensus of multiagent systems under malicious
		attacks: Appointed-time observer-based approach,''
		\emph{IEEE Transactions on Cybernetics},
		vol.~52, no.~10, pp.~10187--10199, 2022.
